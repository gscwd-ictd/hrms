...
const PersonalInformationPdf = props => {
  const { formatDate, basicInfo } = props
    ...
    <View>
      ...
      <View style={[styles.lineContainer, styles.borderTop]}>
        ...
        <View style={[styles.w82_9, styles.inputValue]}>
          <Text>{basicInfo.personalInfo.lastName || "N/A"}</Text>
        </View>
      </View>
      ...
      <View style={[styles.lineContainer]}>
        ...
        >
          <Text>{basicInfo.personalInfo.firstName || "N/A"}</Text>
        </View>
        <View
          style={[
            styles.inputKey,
        ...
        >
          ...
          <Text style={{ padding: "4 10", fontSize: 5.7 }}>
            {basicInfo.personalInfo.nameExtension || "N/A"}
          </Text>
        </View>
      </View>
      ...
      <View style={[styles.lineContainer]}>
        ...
        <View style={[styles.borderTop, styles.w82_9, styles.inputValue]}>
          <Text>{basicInfo.personalInfo.middleName || "N/A"}</Text>
        </View>
      </View>
      ...
      <View style={[styles.lineContainer, styles.borderTop]}>
        <View style={[styles.lineContainer, styles.w42]}>
          ...
          <View style={[styles.borderRight, styles.inputValue, styles.w59_3]}>
            <Text>{formatDate(basicInfo.personalInfo.birthDate)}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              {basicInfo.personalInfo.citizenship === "Filipino" ? (
            ...
            <View style={{ flexDirection: "row", paddingLeft: 25 }}>
              {basicInfo.personalInfo.citizenship === "Dual Citizenship" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            <View style={{ flexDirection: "row", paddingLeft: 75 }}>
              {basicInfo.personalInfo.citizenshipType === "By birth" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
            ...
            <View style={{ flexDirection: "row", paddingLeft: 20 }}>
              {basicInfo.personalInfo.citizenshipType ===
              "By naturalization" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          <View style={[styles.borderRight, styles.inputValue, styles.w59_3]}>
            <Text>{basicInfo.personalInfo.birthPlace}</Text>
          </View>
        </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              {basicInfo.personalInfo.sex === "Male" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
            ...
            <View style={{ flexDirection: "row", paddingLeft: 25 }}>
              {basicInfo.personalInfo.sex === "Female" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            <Text>{basicInfo.personalInfo.country || "N/A"}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              {basicInfo.personalInfo.civilStatus === "Single" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
            ...
            <View style={{ flexDirection: "row", paddingLeft: 22 }}>
              {basicInfo.personalInfo.civilStatus === "Married" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
        ...
        <View style={[styles.lineContainer, styles.borderTop, styles.w58]}>
          ...
          >
            ...
            <Text style={[styles.w50]}>
              {basicInfo.address.residentialAddress.street || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.w42]}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              {basicInfo.personalInfo.civilStatus === "Widowed" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
            ...
            <View style={{ flexDirection: "row", paddingLeft: 15 }}>
              {basicInfo.personalInfo.civilStatus === "Separated" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.w42]}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              {basicInfo.personalInfo.civilStatus === "Others" ? (
                <Svg viewBox="0 0 24 24" width={7} height={7}>
                  <Path
                    d="M11 17l-5-5.299 1.399-1.43 3.574 3.736 6.572-7.007 1.455 1.403-8 8.597zm11-15v20h-20v-20h20zm2-2h-24v24h24v-24z"
                    stroke="black"
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            ...
            <Text style={[styles.w50]}>
              {basicInfo.address.residentialAddress.barangay || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.personalInfo.height || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            <Text style={[styles.w50]}>
              {basicInfo.address.residentialAddress.city || "N/A"}
            </Text>
            <Text style={[styles.w50]}>
              {basicInfo.address.residentialAddress.province || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.personalInfo.weight || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            <Text style={[styles.w100]}>
              {basicInfo.address.residentialAddress.zipCode || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.personalInfo.bloodType || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.borderTop, styles.w58]}>
          ...
          >
            ...
            <Text style={[styles.w50]}>
              {basicInfo.address.permanentAddress.street || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.governmentIssuedIds.gsisNumber || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            ...
            <Text style={[styles.w50]}>
              {basicInfo.address.permanentAddress.barangay || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.governmentIssuedIds.pagibigNumber || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            <Text style={[styles.w50]}>
              {basicInfo.address.permanentAddress.city || "N/A"}
            </Text>
            <Text style={[styles.w50]}>
              {basicInfo.address.permanentAddress.province || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        ...
        <View style={[styles.lineContainer, styles.w58]}>
          ...
          >
            <Text style={[styles.w100]}>
              {basicInfo.address.permanentAddress.zipCode || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.governmentIssuedIds.sssNumber || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.borderTop, styles.w58]}>
          ...
          <View style={[styles.inputValue, styles.w73_5, { padding: "4 8" }]}>
            <Text style={[styles.w100]}>
              {basicInfo.personalInfo.telNumber || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.governmentIssuedIds.tinNumber || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.borderTop, styles.w58]}>
          ...
          <View style={[styles.inputValue, styles.w73_5, { padding: "4 8" }]}>
            <Text style={[styles.w100]}>
              {basicInfo.personalInfo.mobileNumber || "N/A"}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.lineContainer}>
        <View style={[styles.lineContainer, styles.borderTop, styles.w42]}>
          ...
          >
            <Text>{basicInfo.governmentIssuedIds.agencyNumber || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={[styles.lineContainer, styles.borderTop, styles.w58]}>
          ...
          <View style={[styles.inputValue, styles.w73_5, { padding: "4 8" }]}>
            <Text style={[styles.w100]}>
              {basicInfo.personalInfo.email || "N/A"}
            </Text>
          </View>
        </View>
      </View>
