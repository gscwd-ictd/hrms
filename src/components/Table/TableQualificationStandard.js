...
const TableQualificationStandard = props => {
  ...
  const tableInstance = useTable(
    {
      ...
      initialState: {
        pageIndex: 0,
        hiddenColumns: ["positionId", "education", "experience", "training"],
      },
    },
    useFilters,
    useGlobalFilter,
...
TableQualificationStandard.propTypes = {
  columns: PropTypes.array,
  data: PropTypes.array,
}

export default TableQualificationStandard
