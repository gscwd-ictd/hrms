...
const TablePositionFunctionalCompetencies = props => {
...
TablePositionFunctionalCompetencies.propTypes = {
...
export default TablePositionFunctionalCompetencies
